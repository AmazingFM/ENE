...
-(void)setYLabels:(NSArray *)yLabels
{
    ...
    for (int i=0; i<5; i++) {
        if ([_showHorizonLine[i] integerValue]>0) {
            ...
            [path addLineToPoint:CGPointMake(self.frame.size.width-kUUChartRightPadding,UULabelHeight+i*levelHeight)];
            [path closePath];
...
-(void)setXLabels:(NSArray *)xLabels
{
    ...
    _xLabelWidth = (self.frame.size.width - UUYLabelwidth-kUUChartRightPadding)/(num-1);
...
//        UUChartLabel * label = [[UUChartLabel alloc] initWithFrame:CGRectMake(i * _xLabelWidth+UUYLabelwidth, self.frame.size.height - UULabelHeight, _xLabelWidth, UULabelHeight)];
        UUChartLabel * label = [[UUChartLabel alloc] initWithFrame:CGRectMake(i * _xLabelWidth+UUYLabelwidth-_xLabelWidth/2, self.frame.size.height - UULabelHeight, _xLabelWidth, UULabelHeight)];
