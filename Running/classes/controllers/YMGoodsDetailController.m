...
- (void)setupView
{
    bigScroll = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, g_screenWidth, g_screenHeight-44)];
...
//    webView.frame = frame;
//
//    CGFloat offset = fittingSize.height-webViewHeight;
...
//    CGFloat offsetHeight = [[webview stringByEvaluatingJavaScriptFromString:@"document.body.offsetHeight"] floatValue];
    ...
    CGFloat newWebHeight = scrollHeight;//(offsetHeight<=scrollHeight)?offsetHeight:scrollHeight;
